...
if(!class_exists('SumOfficeOutfittersLicense')) 
{
    class SumOfficeOutfittersLicense
    {
        /**
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false)
        {
            ...
            $validated = SumOfficeOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = SumOfficeOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null)
        {
            ...
            {
                $GLOBALS['log']->fatal('SumOfficeOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('SumOfficeOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = SumOfficeOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API
    {
        private static function get_default_payload($module,$custom_data = array())
        {
            ...
            if (empty($custom_data['key'])){
                $key = SumOfficeOutfittersLicense::getKey($module);
